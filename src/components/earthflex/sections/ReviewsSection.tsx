...
const TESTIMONIALS = [
  {
    id: 1,
    quote: "The heat-resistant belts from Earth Flex have exceeded our expectations. We have seen a 40% reduction in downtime on our high-temperature clinker transport lines under severe 180°C operating conditions.",
    author: "Rajesh Mehta",
  ...
  {
    id: 3,
    quote: "Earth Flex fire-resistant belts are the gold standard for safety in our underground coal mining operations. Zero combustion risk, absolute safety compliance, and incredible wear-life.",
    author: "Amitabha Roy",
