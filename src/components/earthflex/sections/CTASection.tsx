    ...
    <section className="relative  overflow-hidden">
      ...
      <div className="container-custom relative z-10 ">
        <motion.div
          ...
          className="cta-card-wrapper relative overflow-hidden rounded-xl md:rounded-[24px] border border-white/10 bg-linear-to-br from-[#111827] to-[#0d1117] p-6 sm:p-12 lg:p-16 shadow-2xl shadow-accent/5"
        >
          ...
          <div className="absolute inset-0 z-0 select-none pointer-events-none">
            ...
            <div className="absolute inset-0 bg-linear-to-br from-[#111827]/95 via-[#0d1117]/90 to-[#0d1117]/95" />
          </div>
          ...
          <div 
            ...
            style={{
              backgroundImage: "radial-gradient(#0B8A1E 1px, transparent 1px)",
