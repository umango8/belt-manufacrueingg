...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-[#111827] text-white/80 relative overflow-hidden pt-20 pb-8 border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 sm:gap-12 gap-10 lg:gap-8 items-start mb-16">
          ...
          <div className="lg:col-span-3 flex items-center justify-center gap-4 h-full py-6 lg:py-12 z-10">
            ...
            <svg className="w-24 h-12 text-white/5 hidden xl:block shrink-0" viewBox="0 0 100 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Dotted lines path */}
              <path d="M 20 20 L 60 20 L 70 25 L 100 25" stroke="#0B8A1E" strokeWidth="1" strokeOpacity="0.4" strokeDasharray="3 3" />
              <circle cx="60" cy="20" r="2" fill="#0B8A1E" className="animate-pulse" />
            </svg>

            {/* Central Sleek Call To Action Button */}
            <Link
              href="/quote"
              className="inline-flex items-center gap-3 px-5 py-3.5 bg-[#111827] border border-white/10 hover:border-accent/40 rounded-xl transition-all duration-500 shadow-xl group hover:shadow-accent/5 hover:-translate-y-0.5 shrink-0"
            >
            ...
            <svg className="w-24 h-12 text-white/5 hidden xl:block shrink-0" viewBox="0 0 100 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* Dotted lines path */}
              <path d="M 0 25 L 30 25 L 40 30 L 80 30" stroke="#0B8A1E" strokeWidth="1" strokeOpacity="0.4" strokeDasharray="3 3" />
              <circle cx="30" cy="25" r="2" fill="#0B8A1E" className="animate-pulse" />
            </svg>
          </div>
          ...
          <div className="lg:col-span-3 flex flex-col items-start lg:items-end w-full">
            ...
            <div className="flex flex-col items-start lg:items-end gap-3.5">
              ...
              <Link 
                href="/earthflex#products" 
                className="text-sm font-bold text-white/50 hover:text-white transition-all duration-300 hover:translate-x-1 lg:hover:translate-x-[-8px] tracking-tight font-heading"
              >
                Products
              </Link>
              <Link 
                href="/earthflex#industries" 
                className="text-sm font-bold text-white/50 hover:text-white transition-all duration-300 hover:translate-x-1 lg:hover:translate-x-[-8px] tracking-tight font-heading"
              >
                Industries Served
              </Link>
              <Link 
                href="/earthflex#process" 
                className="text-sm font-bold text-white/50 hover:text-white transition-all duration-300 hover:translate-x-1 lg:hover:translate-x-[-8px] tracking-tight font-heading"
              >
                Our Process
              </Link>
