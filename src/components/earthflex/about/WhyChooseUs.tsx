  ...
  return (
    ...
    >
      ...
      <div className="container-custom relative z-10">
        {/* Section Header */}
        <div className="text-left md:mb-16 sm:mb-12 mb-10 lg:mb-16 max-w-3xl">
          <motion.div
          ...
          >
            The <span className="text-accent">Earth Flex</span> Difference
          </motion.h2>
          ...
          >
            Six pillars of excellence that make Earth Flex the preferred conveyor
