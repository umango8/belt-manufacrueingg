...
const DETAIL_SECTIONS = [
  ...
  },
  {
    ...
    solution:
      "Earth Flex food-grade belts use FDA-approved polyurethane and PVC compounds with sealed edges, anti-microbial surface treatments, and easy-clean profiles — meeting HACCP and GMP requirements.",
    benefits: [
