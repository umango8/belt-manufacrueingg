        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
          <div className="max-w-3xl text-left">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-[2.25rem] font-semibold text-white leading-[1.3] tracking-tight text-left mt-6">
              High-performance belts regardless of your <span className="text-white/60 font-normal">operational challenges</span>
            </h2>
          </div>
        ...
        <div className="flex gap-6 animate-marquee-custom w-max px-6 md:px-12">
          {DOUBLE_SERVICES.map((service, index) => {
            ...
            return (
              <div
                key={uniqueKey}
                className="group relative overflow-hidden rounded-3xl h-[440px] w-[310px] shrink-0 p-8 flex flex-col justify-between border border-white/5 transition-shadow duration-500 cursor-pointer"
              >
                ...
                <div className="relative w-full h-full flex flex-col justify-end overflow-hidden pt-12 z-10">
                  ...
                  <div className="translate-y-[194px] group-hover:translate-y-0 transition-transform duration-500 ease-out flex flex-col justify-end">
                    ...
                    <p className="text-[13.5px] text-white/80 leading-[1.55] text-left mb-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-[100ms] font-medium">
                      {service.description}
                    </p>
