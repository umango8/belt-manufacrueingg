...
export const PRODUCT_CATALOG = [
  {
    ...
    overview:
      "Earth Flex Conveyor Belts are engineered for the most demanding material handling applications. Our multi-ply rubber construction ensures exceptional durability, load-bearing capacity, and resistance to operational wear in heavy industries.",
    description:
  ...
  },
  {
    ...
    overview:
      "Earth Flex Polyurethane Belts offer an unmatched combination of strength, flexibility, and hygienic properties. FDA-compliant formulations make them essential in food processing, pharmaceutical, and clean-room applications.",
    description:
  ...
  },
  {
    ...
    image: "/product-conveyor-belt.png",
    overview:
      "Earth Flex Rubber Belts are formulated for high-impact, abrasive, and chemically aggressive environments. SBR, NR, and specialty compound options deliver tailored performance for your toughest conveying challenges.",
    description:
      "Our Rubber Conveyor Belts are manufactured from carefully selected natural rubber (NR), styrene-butadiene rubber (SBR), and specialty compound blends to handle the most demanding industrial environments. Whether transporting sharp rock, hot clinker, or chemically aggressive materials, Earth Flex rubber belts deliver unmatched durability.",
  ...
  },
  {
    ...
    image: "/product-heat-resistant.png",
    overview:
      "Earth Flex Transmission Belts — including V-belts, wedge belts, and wrapped drives — deliver efficient, reliable power transmission across pumps, compressors, fans, and industrial machinery.",
    description:
      "Power Transmission Belts from Earth Flex are engineered to transfer mechanical power with maximum efficiency and minimum maintenance. Our V-belt, wedge belt, and banded belt range covers all standard cross-sections (A, B, C, D, E, SPZ, SPA, SPB, SPC) and custom lengths, meeting or exceeding ISO 4184 and DIN 2215 standards.",
  ...
  },
  {
    ...
    image: "/product-oil-resistant.png",
    overview:
      "Earth Flex Flat Belts provide smooth, high-speed conveying and power transmission for textile machinery, woodworking, printing, and high-precision manufacturing where quiet, efficient drives are essential.",
    description:
      "Flat Belts from Earth Flex excel in applications requiring high-speed, smooth, and vibration-free operation. Manufactured from high-quality rubber, polyurethane, or leather substitute compounds with polyamide or polyester reinforcement, these belts maintain consistent tension and alignment even at speeds exceeding 50 m/s.",
  ...
  },
  {
    ...
    image: "/product-oil-resistant.png",
    overview:
      "Earth Flex's Custom Belt Engineering division designs and manufactures fully bespoke industrial belts for unique operational challenges that standard off-the-shelf products cannot solve.",
    description:
      "When standard belt products cannot meet your specific operational, environmental, or dimensional requirements, Earth Flex's Custom Belt Engineering team delivers fully tailored solutions. From concept design and material selection through prototyping, testing, and production, we engineer belts that solve your exact problem. Our engineering team has resolved over 200 unique custom belt challenges.",
...
export const INDUSTRY_CATALOG = [
  {
    ...
    overview:
      "The textile industry demands belts with exceptional grip, minimal elongation, and consistent tension across high-speed spinning and weaving operations. Earth Flex delivers precision flat belts, timing belts, and spindle tapes that maintain dimensional stability under continuous load — ensuring zero-slip performance on looms, spinning frames, and garment production lines.",
    challenge:
  ...
  },
  {
    ...
    overview:
      "Modern packaging lines operate at extremely high speeds with zero tolerance for belt-related failures. Earth Flex packaging belts deliver superior grip, low friction undersides, and consistent tracking — keeping carton sealing, labeling, shrink wrapping, and automated sorting systems running at peak efficiency.",
    challenge:
  ...
  },
  {
    ...
    solution:
      "Earth Flex pharmaceutical belts are manufactured from certified, traceable materials with sealed edges and non-porous surfaces that prevent particle shedding and microbial harborage. Our anti-static formulations safely dissipate charges, while our belts withstand CIP/SIP cycles without degradation.",
    benefits: [
  ...
  },
  {
    ...
    overview:
      "Modern logistics and warehousing operations handle millions of packages daily, requiring conveyor belt systems that deliver exceptional reliability, speed, and sortation accuracy. Earth Flex logistics belts are engineered for 24/7 high-volume distribution centers, e-commerce fulfillment hubs, and automated sorting systems.",
    challenge:
    ...
    solution:
      "Earth Flex logistics belts feature impact-absorbing top covers, low-stretch polyester carcasses, and precision-tracking profiles that maintain alignment through curves and inclines. Our modular belt systems allow rapid zone replacement without full-belt changeouts, minimizing downtime in critical sorting operations.",
    benefits: [
  ...
  },
  {
    ...
    overview:
      "Ceramic manufacturing subjects conveyor belts to extreme heat near kilns, highly abrasive glazing materials, and heavy tile loads. Earth Flex ceramic-grade belts are engineered with heat-resistant compounds and abrasion-proof surfaces that withstand the harshest conditions in tile, sanitaryware, and technical ceramic production.",
    challenge:
    ...
    solution:
      "Earth Flex ceramic belts use heat-stabilized EPDM and silicone compounds rated for continuous operation at elevated temperatures. Our super-abrasion-resistant (SAR) top covers withstand glazing material contact, while non-marking surfaces prevent product discoloration during transport.",
    benefits: [
  ...
  },
  {
    ...
    overview:
      "Paper manufacturing is one of the most demanding environments for conveyor belts, combining high moisture, aggressive chemicals, extreme temperatures, and continuous high-speed operation. Earth Flex paper-grade belts deliver moisture-proof, chemical-resistant performance for pulp handling, paper converting, and corrugation production lines.",
    challenge:
  ...
  },
  {
    ...
    overview:
      "Agricultural belt applications span from grain harvesting and processing to livestock feed systems and farm machinery power transmission. Earth Flex agricultural belts are built rugged — engineered to withstand outdoor exposure, abrasive grain handling, and the demanding duty cycles of modern farming operations.",
    challenge:
    ...
    solution:
      "Earth Flex agricultural belts use UV-stabilized rubber compounds with ozone-resistant formulations that withstand years of outdoor exposure. Our chevron and rough-top profiles prevent grain rollback on inclined conveyors, while our heavy-duty rubber lagging protects drive pulleys from wear in grain elevator applications.",
    benefits: [
